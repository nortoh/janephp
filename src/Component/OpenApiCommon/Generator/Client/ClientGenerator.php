            ...
            'create', [
                ...
                'stmts' => [
                    ...
                    new Stmt\Expression(new Expr\Assign(
                        ...
                        new Expr\Array_([
                            new ArrayItem(new Expr\New_(new Name('\\Symfony\\Component\\Serializer\\Normalizer\\ArrayDenormalizer'))),
                            new ArrayItem(new Expr\New_(new Name('\\' . $context->getCurrentSchema()->getNamespace() . '\\Normalizer\\JaneObjectNormalizer'))),
                        ])
                    )),
                    new Stmt\If_(
                                            ...
                                            new Expr\New_(new Name\FullyQualified(JsonEncoder::class), [
                                                ...
                                                new Node\Arg(new Expr\New_(new Name\FullyQualified(JsonDecode::class), [
                                                    new Node\Arg(new Expr\Array_([
                                                        new ArrayItem(new Expr\ConstFetch(new Name('true')), new Scalar\String_('json_decode_associative')),
                                                    ])),
                                                ])),
                                            ])
                                        ),
